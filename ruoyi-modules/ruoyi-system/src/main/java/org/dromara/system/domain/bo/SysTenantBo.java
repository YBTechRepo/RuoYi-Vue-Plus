...
public class SysTenantBo extends BaseEntity {
     ...
     * 企业联系人
     */
    @NotBlank(message = "企业联系人不能为空", groups = { AddGroup.class, EditGroup.class })
    private String contactUserName;

    /**
     * 企业联系电话
     */
    @NotBlank(message = "企业联系电话不能为空", groups = { AddGroup.class, EditGroup.class })
     ...
     * 管理员用户名（创建系统用户）
     */
    @NotBlank(message = "管理员用户名不能为空", groups = { AddGroup.class })
    private String username;

    /**
     * 密码（创建系统用户）
     */
    @NotBlank(message = "管理员密码不能为空", groups = { AddGroup.class })
